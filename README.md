...
- Navigate to [safe-cross-origin.html](safe-cross-origin.html) and check the [source code](https://github.com/amondal-netspi/Test/blob/main/SRI/safe-cross-origin.html) of the page.
...
- Navigate to [unsafe-cross-origin.html](unsafe-cross-origin.html) and check the [source code](https://github.com/amondal-netspi/Test/blob/main/SRI/unsafe-cross-origin.html) of the page.
